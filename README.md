[![Remote Tests](https://github.com/BrownandCaldwell/python-starter-template/actions/workflows/checks.yml/badge.svg)](https://github.com/BrownandCaldwell/python-starter-template/actions/workflows/checks.yml)
